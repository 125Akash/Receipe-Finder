...
const Recipe = ({ recipe }) => {
  return (
    <div className="recipe w-80 overflow-hidden bg-white rounded-3xl shadow-xl p-5 shadow-red-100 border-2 border-white flex flex-col gap-5">
      <img
      ...
      <div className="texts">
        <span className=" publisher text-xs uppercase text-pink-700 font-semibold tracking-widest">
          {recipe.publisher}
        </span>
