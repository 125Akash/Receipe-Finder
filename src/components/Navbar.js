...
const Navbar = ({
  ...
  return (
    <div className="navbar flex justify-between items-center container mx-auto py-8 flex-col lg:flex-row gap-5 lg:gap-0">
      <h2 className="logo text-2xl font-bold uppercase italic">
      Spice<span className="text-rose-500">Sailors</span>
      </h2>
      ...
      <ul className="menu flex gap-5">
        ...
        <li>
          ...
          >
            Favourites
            <span className="favourites-count font-bold text-violet-800">
              ({savedItems.length})
            </span>
          </NavLink>
        </li>
